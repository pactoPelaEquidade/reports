...
\begin{figure}[H]
    ...
    \begin{floatnotes}
        \item[Fonte:] Pesquisa Nacional por Amostra de Domicílios Contínua. 2º trimestre/2022.
        \item[Notas:] Para o cálculo, foram considerados apenas rendimento do trabalho de pessoas com idade entre 14 e 65 anos. Entre os ocupados, não foram considerados empregadores e \enquote{Trabalhador familiar auxiliar}.
    \end{floatnotes}
\end{figure}
