EXPORT DATA
  OPTIONS (
    uri = 'gs://pacto-report-women/supply_gap/*.parquet',
    format = 'parquet',
    overwrite = true) AS
SELECT *
FROM (
  ...
  PIVOT (COUNT(*) FOR extrato IN ("Homem_Negro", "Mulher_Branca", "Mulher_Indigena", "Homem_Indigena", "Mulher_Negro", "Homem_Branca"))
  ORDER BY ano
)
LIMIT 11